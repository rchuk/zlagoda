...
class CustomerCardView(BaseModel):
    """
    CustomerCardView
    """ # noqa: E501
    ...
    discount_percent: StrictInt = Field(alias="discountPercent")
    city: Optional[StrictStr] = None
    street: Optional[StrictStr] = None
    zip_code: Optional[StrictStr] = Field(default=None, alias="zipCode")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "patronymic", "phoneNumber", "discountPercent", "city", "street", "zipCode"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomerCardView from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CustomerCardView from a dict"""
        if obj is None:
            return None
