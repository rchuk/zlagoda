...
class EmployeeCriteria(BaseModel):
    """
    EmployeeCriteria
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "sortField", "sortAscending", "ids", "query", "role", "lastName"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EmployeeCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EmployeeCriteria from a dict"""
        if obj is None:
            return None
