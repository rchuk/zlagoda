...
class ProductArchetypeCriteria(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "sortField", "sortAscending"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductArchetypeCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductArchetypeCriteria from a dict"""
        if obj is None:
            return None
