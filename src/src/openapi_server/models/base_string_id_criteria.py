...
class BaseStringIdCriteria(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "sortField", "sortAscending", "ids"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BaseStringIdCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BaseStringIdCriteria from a dict"""
        if obj is None:
            return None
