...
class ReceiptView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customerCardId", "items"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ReceiptView from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ReceiptView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [ReceiptItemView.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
